  ...
  <section>
    <el-row style='margin: 10px 10px 10px 10px;'>
      <el-breadcrumb separator-class='el-icon-arrow-right'>
        <el-breadcrumb-item :to='{path: "/wechats"}'>学生管理</el-breadcrumb-item>
        <el-breadcrumb-item>学生微信</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <el-card style='margin: 20px 1%;width: 100%'>
      ...
      <el-table :data="wechats" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
...
export default {
  ...
  methods: {
    ...
    getWechats () {
      ...
      var _this = this
      /*
      this.$axios.post('/student/wechats/select', {
          page: this.page,
        ...
        */
      this.$axios.get('/student/wechats/select').then(res => {
    ...
    handleDel: function (index, row) {
      this.$confirm('确认删除该记录吗?', '提示', {
        ...
        // 提交数据到后台
        this.$axios.post('/student/wechats/delete', {
          id: para.id
        }).then(res => {
          this.listLoading = false
          // NProgress.done()
      ...
      this.$refs.editForm.validate(valid => {
        if (valid) {
          this.$confirm('确认提交吗？', '提示', {}).then(() => {
            ...
            // eslint-disable-next-line no-undef
            // 提交数据到后台
            this.$axios.post('/student/wechats/update', {
              id: para.id,
              cover: para.cover,
              title: para.title,
              author: para.author,
      ...
      this.$refs.addForm.validate(valid => {
        if (valid) {
          this.$confirm('确认提交吗？', '提示', {}).then(() => {
            ...
            // eslint-disable-next-line no-undef
            // 提交数据到后台
            this.$axios.post('/student/wechats/insert', {
              id: para.id,
              cover: para.cover,
              title: para.title,
              author: para.author,
