  ...
  <section>
    <el-row style='margin: 10px 10px 10px 10px;'>
      <el-breadcrumb separator-class='el-icon-arrow-right'>
        ...
        <el-breadcrumb-item :to='{path: "/answer"}'>习题资源</el-breadcrumb-item>
        <el-breadcrumb-item>问题文件</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <el-dialog title='新增' :visible.sync='addFormVisible' :close-on-click-modal='false' @close="resetForm('addForm')">
      <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
        ...
        <el-form-item label="问题文件" prop="uploadFile">
          <el-upload
            class="upload-demo"
            action="https://jsonplaceholder.typicode.com/posts/"
            :on-change="handleChange"
            :file-list="fileList">
            <el-button size="small" type="primary">上传问题</el-button>
            <div slot="tip" class="el-upload__tip"></div>
          </el-upload>
        </el-form-item>
        <el-form-item label='问题说明' prop='memo'>
          <el-input type='textarea' v-model='addForm.memo' auto-complete='off' maxlength="500" show-word-limit></el-input>
        </el-form-item>
      </el-form>
      <div slot='footer' class='dialog-footer'>
  ...
  methods: {
    ...
    getQuestions () {
      ...
      this.$axios.post('/library/question/select', {
        ...
        */
      this.$axios.get('/api/library/question/select').then(res => {
