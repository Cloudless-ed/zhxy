  ...
  <section>
    <el-row style='margin: 10px 10px 10px 10px;'>
      <el-breadcrumb separator-class='el-icon-arrow-right'>
            ...
            <el-breadcrumb-item :to='{path: "/cartoon"}'>动画资源</el-breadcrumb-item>
            <el-breakcrumb-item>动画文件</el-breakcrumb-item>
        </el-breadcrumb>
    </el-row>
    <el-card style='margin: 20px 1%;width: 100%'>
      <el-col :span='24' class='toolbar' style='padding-bottom: 0px'>
        <el-form :inline='true' :model='filters'>
          <el-form-item>
            <el-input v-model='filters.name' placeholder='动画文件'></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="cartoons" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop='classify.classifyName' label='动画名称' width='120' sortable></el-table-column>
        <el-table-column prop='grade.gradeName' label='动画说明' width='120' sortable></el-table-column>
    ...
    <!-- <el-dialog title='编辑' :visible.sync='editFormVisible' :close-on-click-modal='false'>
      <el-form :model='editForm' label-width='80px' :rules='editFormRules' ref='editForm'>
        <el-form-item label='动画文件' prop='cartoonName'>
        ...
        <el-form-item label='微课说明' prop='cartoonDesc'>
    ...
    <el-dialog title='新增' :visible.sync='addFormVisible' :close-on-click-modal='false' @close="resetForm('addForm')">
      <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
        <el-form-item label="动画文件" prop="uploadFile">
          <el-upload
            class="upload-demo"
        ...
        <el-form-item label='动画说明' prop='memo'>
...
<script>
  export default {
    ...
    methods: {
      ...
      getcartoons () {
        ...
        this.$axios.post('/library/cartoon/select', {
          ...
          */
        this.$axios.get('/api/library/cartoon/select').then(res => {
    ...
    mounted () {
      this.currentId = getQueryString('id');
      this.getcartoons()
    }
  }
</script>
