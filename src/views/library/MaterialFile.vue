  ...
  <section>
    <el-row style='margin: 10px 10px 10px 10px;'>
      <el-breadcrumb separator-class='el-icon-arrow-right'>
            ...
            <el-breadcrumb-item :to='{path: "/material"}'>素材资源</el-breadcrumb-item>
            <el-breakcrumb-item>素材文件</el-breakcrumb-item>
        </el-breadcrumb>
    </el-row>
    <el-card style='margin: 20px 1%;width: 100%'>
      <el-col :span='24' class='toolbar' style='padding-bottom: 0px'>
        <el-form :inline='true' :model='filters'>
          <el-form-item>
            <el-input v-model='filters.name' placeholder='素材文件'></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="materials" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop='classify.classifyName' label='素材名称' width='120' sortable></el-table-column>
        <el-table-column prop='grade.gradeName' label='素材说明' width='120' sortable></el-table-column>
    ...
    <el-dialog title='新增' :visible.sync='addFormVisible' :close-on-click-modal='false' @close="resetForm('addForm')">
      <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
        <el-form-item label="素材文件" prop="uploadFile">
          <el-upload
            class="upload-demo"
        ...
        <el-form-item label='素材说明' prop='memo'>
    ...
    methods: {
      ...
      getmaterials () {
        ...
        this.$axios.post('/library/material/select', {
          ...
          */
        this.$axios.get('/api/library/material/select').then(res => {
