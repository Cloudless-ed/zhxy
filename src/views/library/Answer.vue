  ...
  <section>
    <el-row style='margin: 10px 10px 10px 10px;'>
      <el-breadcrumb separator-class='el-icon-arrow-right'>
        ...
        <el-breadcrumb-item>答案管理</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
  ...
  methods: {
    ...
    getAnswers () {
      ...
      this.$axios.post('/library/answer/select', {
        ...
        */
      this.$axios.post('/api/library/answer/select',{
        pageId:'1',
        limit:'1',
        searchKey:'1'
      }).then(res => {
        ...
        if (valid) {
          this.$confirm('确认提交吗？', '提示', {}).then(() => {
            ...
            this.$axios.post('/api/library/answer/update', {
              ...
              answerNo:para.answerNo,
              answerDesc:para.answerDesc,
              memo:para.memo
            }).then(res => {
