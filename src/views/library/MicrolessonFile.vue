  ...
  <section>
    <el-row style='margin: 10px 10px 10px 10px;'>
      <el-breadcrumb separator-class='el-icon-arrow-right'>
            ...
            <el-breadcrumb-item :to='{path: "/video"}'>微课资源</el-breadcrumb-item>
            <el-breakcrumb-item>微课文件</el-breakcrumb-item>
        </el-breadcrumb>
    </el-row>
    <el-card style='margin: 20px 1%;width: 100%'>
      <el-col :span='24' class='toolbar' style='padding-bottom: 0px'>
        <el-form :inline='true' :model='filters'>
          <el-form-item>
            <el-input v-model='filters.name' placeholder='微课文件'></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="microlessons" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop='classify.classifyName' label='微课名称' width='120' sortable></el-table-column>
        <el-table-column prop='grade.gradeName' label='微课说明' width='120' sortable></el-table-column>
      ...
      <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
        <el-form-item label="视频文件" prop="uploadFile">
          <el-upload
            ...
            :file-list="fileList">
            <el-button size="small" type="primary">上传微课</el-button>
            <div slot="tip" class="el-upload__tip"></div>
          </el-upload>
        </el-form-item>
        <el-form-item label='微课说明' prop='memo'>
    ...
    methods: {
      ...
      getMicrolessons () {
        ...
        this.$axios.post('/library/microlesson/select', {
          ...
          */
        this.$axios.get('/api/library/microlesson/select').then(res => {
