  ...
  <section>
    <el-row style='margin: 10px 10px 10px 10px;'>
      <el-breadcrumb separator-class='el-icon-arrow-right'>
            ...
            <el-breadcrumb-item :to='{path: "/video"}'>习题资源</el-breadcrumb-item>
            <el-breakcrumb-item>习题文件</el-breakcrumb-item>
        </el-breadcrumb>
    </el-row>
    <el-card style='margin: 20px 1%;width: 100%'>
      <el-col :span='24' class='toolbar' style='padding-bottom: 0px'>
        <el-form :inline='true' :model='filters'>
          <el-form-item>
            <el-input v-model='filters.name' placeholder='习题文件'></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-table-column type='expand'>
          <template slot-scope='props'>
            <el-form label-position='left' inline>
              <el-form-item>
                <span>{{ props.row.exerciseDesc }}</span>
              </el-form-item>
            </el-form>
          </template>
        </el-table-column>
        <el-table-column prop='classify.classifyName' label='习题名称' width='120' sortable></el-table-column>
        <el-table-column prop='grade.gradeName' label='习题说明' width='120' sortable></el-table-column>
    ...
    <el-dialog title='新增' :visible.sync='addFormVisible' :close-on-click-modal='false' @close="resetForm('addForm')">
      <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
        <el-form-item label="习题文件" prop="uploadFile">
          <el-upload
            class="upload-demo"
        ...
        <el-form-item label='习题说明' prop='memo'>
  ...
  methods: {
    ...
    getExercises () {
      ...
      this.$axios.post('/library/exercise/select', {
        ...
        */
      this.$axios.get('/api/library/exercise/select').then(res => {
