  ...
  <section>
    ...
    <el-card style='margin: 20px 1%;width: 100%'>
      <el-col :span='24' class='toolbar' style='padding-bottom: 0px'>
        <el-form :inline='true' :model='filters'>
          <el-form-item>
            <el-input v-model='filters.name' placeholder='视频名称'></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="videos" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop='videoName' label='视频名称' width='120' sortable></el-table-column>
    ...
    <el-dialog title='编辑' :visible.sync='editFormVisible' :close-on-click-modal='false'>
      <el-form :model='editForm' label-width='80px' :rules='editFormRules' ref='editForm'>
        <el-form-item label='视频名称' prop='videoName'>
          <el-input v-model='editForm.videoName' auto-complete='off'></el-input>
        </el-form-item>
        ...
        <el-form-item label='关 键 词' prop='videoWord'>
          <el-input v-model='editForm.videoWord' auto-complete='off'></el-input>
        </el-form-item>
        <el-form-item label='视频说明' prop='videoDesc'>
          <el-input v-model='editForm.videoDesc' auto-complete='off'></el-input>
        </el-form-item>
    ...
    <el-dialog title='新增' :visible.sync='addFormVisible' :close-on-click-modal='false' @close="resetForm('addForm')">
      <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
        <el-form-item label='视频名称' prop='videoName'>
          <el-input v-model='addForm.videoName' auto-complete='off'></el-input>
        </el-form-item>
        <el-form-item label='体系名称' prop='classify'>
        ...
        <el-form-item label='关 键 词' prop='videoWord'>
          <el-input v-model='addForm.videoWord' auto-complete='off'></el-input>
        </el-form-item>
        <el-form-item label='视频说明' prop='videoDesc'>
          <el-input type="textarea" v-model='addForm.videoDesc' auto-complete='off' maxlength="100" show-word-limit></el-input>
        </el-form-item>
        <el-form-item label='备注' prop='memo'>
      ...
      <div slot='footer' class='dialog-footer'>
        <!-- <el-button type="primary" @click="toVideoFile()">操作</el-button> -->
  ...
  methods: {
    ...
    getVideos () {
      ...
      this.$axios.post('/library/video/select', {
        ...
        */
      this.$axios.post('/api/library/video/select',{
        pageId:'1',
        limit:'1',
        searchKey:'1'
      }).then(res => {
        ...
        if (valid) {
          this.$confirm('确认提交吗？', '提示', {}).then(() => {
            ...
            this.$axios.post('/api/library/video/update', {
              ...
              videoCode:para.videoCode,
              videoName:para.videoName,
              videoWord:para.videoWord,
              videoDesc:para.videoDesc,
              memo:para.memo
            }).then(res => {
